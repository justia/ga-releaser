...
const run = () => {
    ...
    const runRelease = (options) => {
        Object.assign(index_1.default, options);
    ...
    if (isDebugEnv) {
        ...
        void log_1.default.group('Release IT config', async () => log_1.default.info(JSON.stringify(config)));
    }
    runRelease(config);
};
try {
